    ...
    return (
        <div className='container register-form'>
            ...
            <form onSubmit={handleRegister} >
                ...
                <input
                    disabled={!agree}
                    className='w-50 mx-auto btn btn-primary mb-2 mt-2'
                    type="submit"
                    value="Register" />
            </form>
            <p> Already a Member of Genius Car? <Link to={'/login'} className='text-danger pe-auto text-decoration-none' onClick={navigateLogin}> Please Login</Link></p>
